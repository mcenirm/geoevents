...
urlpatterns = [
                       ...
                       url(r'^board/(?P<pk>\d+)/(?P<slug>[\w\d\-]+)/$',
                           DirectorDashboardView, name='director-dashboard-view-slug'),
                       url(r'^board/(?P<org>\w+)/$', DirectorDashboardViewOrg,
                           name='director-dashboard-view-org'),

                       url(r'^rate/(?P<model>\w+)/(?P<pk>\d+)/$', SocialRate,
                           name='social-rate'),

                       url(r'^quadchart/(?P<pk>\d+)/$', QuadChartView,
                           name='prog-obs-quad-chart'),

                       url(r'^note/new/$', NoteNew, name='notes-submit-new'),
                       url(r'^report/new/$', ReportNew, name='reports-submit-new'),

                       url(r'^report/link/(?P<pk_report>\d+)/(?P<model>\w+)/(?P<pk_target>\d+)/$',
                           ReportLink, name='reports-linkage'),
                       ...
                       url(r'^action/new/$', ActionNew, name='actions-submit-new'),
                       ...
                       ##    url(r'^billet/new/$', BilletNew, name='billets-submit-new'),
